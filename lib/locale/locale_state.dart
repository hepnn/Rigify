...
import 'package:rigify/locale/utils/json_local_sync.dart';
import 'package:rigify/locale/utils/persistant_state.dart';
...
@freezed
class LocaleState with _$LocaleState implements PersistentState<LocaleState> {
